...
import ru.otus.crm.dao.DbClientDao;
...
public class WebServerWithBasicSecurityDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ///
        var clientDao = new DbClientDao(transactionManager, clientTemplate);
        ...
        UsersWebServer usersWebServer =
                new UsersWebServerWithBasicSecurity(WEB_SERVER_PORT, loginService, clientDao, templateProcessor);
